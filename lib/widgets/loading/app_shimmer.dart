...
/// (streak count | circular progress ring | steps).
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            // Left — streak box
            Expanded(
              child: AppShimmer.box(height: 90, radius: 16),
            ),
            const SizedBox(width: 12),
            // Center — circular ring placeholder
...
/// (Calories | Heart Rate | Sleep | Calories Left).
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppShimmer.box(width: double.infinity, height: 6, radius: 3),
        ],
      ),
    );
  }
...
/// Skeleton for 3 nutrition entry cards in the Nutrition screen list.
...
/// Skeleton for the profile screen header (avatar + name + subtitle).
...
/// Skeleton for the weight progress chart placeholder.
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            AppShimmer.box(width: double.infinity, height: 180, radius: 16),
            const SizedBox(height: 12),
            Row(
              children: [
